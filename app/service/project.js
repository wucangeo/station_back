    ...
    let error = validator.validate(
      {
        ...
        project_funds: { type: "string", required: false, allowEmpty: true },
        project_depart: { type: "string", required: false, allowEmpty: true },
        project_type: { type: "string", required: false, allowEmpty: true },
        start_date: { type: "date", required: false, allowEmpty: true },
        end_date: { type: "date", required: false, allowEmpty: true },
